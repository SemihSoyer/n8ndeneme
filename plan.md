                        ...
                        └─ Genel Analiz → Message a model (Genel Analiz) ─┤
                                                              ...
                                                              Loop Over Items1 (loop back)
                                                                   ...
                                                                   Combine Results1
                                                                    ...
                                                                    HTTP Request1
Template Tanımları
Fatura: Fatura numarası, tarih, müşteri bilgileri, ürünler, toplam tutar vb.
Fiş Dekont: İşlem tarihi, tutar, işlem tipi, ödeme yöntemi vb.
Tablo: Belgedeki tüm tabloları çıkarır
Sözleşme: Taraflar, tarih, maddeler, imzalar vb.
Genel Analiz: Mevcut prompt (esnek, kullanıcı isteğine göre)
